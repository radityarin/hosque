...
import com.papbl.hosque.activities.DetailBencanaVerifActivity;
import com.papbl.hosque.activities.ProgresBencanaActivity;
...
public class AdapterProgresBencana extends RecyclerView.Adapter<AdapterProgresBencana.ViewHolder> {

    private final Context context;
    private final ArrayList<Bencana> list_bencana = new ArrayList<>();

    public AdapterProgresBencana(Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull final ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.layout_progres_bencana, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent bencanaIntent = new Intent(context, ProgresBencanaActivity.class);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            super(itemView);
            iv_fotobencana = itemView.findViewById(R.id.img_progres_bencana);
            tv_judulbencana = itemView.findViewById(R.id.tv_nama_progres_bencana);
            tv_namaUserBencana = itemView.findViewById(R.id.tv_progres_nama_user_bencana);
            tv_deskripsi = itemView.findViewById(R.id.tv_deskripsi_progres_bencana);
        }
